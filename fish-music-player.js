  ...
  class FishMusicPlayer {
    ...
    render() {
      ...
      <style>
        ...
        .mp-header{padding:20px 20px 0;display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap}
