  ...
  class FishMusicPlayer {
    ...
    render() {
      ...
      <div class="mp-wrap">
        ...
        <div class="hot-bar" style="display:flex;gap:8px;padding:0 16px 8px;flex-wrap:nowrap">
          ...
          <button style="min-width:60px;flex-shrink:0;background:rgba(255,107,157,.15);border:1px solid rgba(255,107,157,.3);border-radius:6px;padding:4px 10px;color:#ff6b9d;cursor:pointer;font-size:.75rem" onclick="this.closest('.mp-wrap').__player.isSearch=false;this.closest('.mp-wrap').__player.loadHot()" style="width:auto;height:32px;background:rgba(255,107,157,.15);border:1px solid rgba(255,107,157,.3);border-radius:8px;color:#ff6b9d;cursor:pointer;font-size:.75rem;flex-shrink:0;padding:4px 10px">🔥 热歌</button>        </div>
