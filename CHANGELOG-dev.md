...
## 2026-05-06 — 新增文字识别 + 二维码扫一扫（总计70个）

### 🆕 新增工具

| 工具 | 文件 | 说明 |
|------|------|------|
| 文字识别 | `fish-ocr.js` | 拍照/上传图片OCR识别，调用MIMO Omni提取文字+MIMO Pro智能解答 |
| 二维码扫一扫 | `fish-qrcode-scanner.js` | 摄像头实时扫描+图片上传解析，支持URL/WiFi/名片/文本识别 |

### 技术要点
- OCR：MIMO Omni 视觉模型，图片base64传入，原样提取文字
- AI解答：MIMO Pro 模型，根据识别内容智能分析（题目解答/文章摘要/代码解释）
- 二维码：jsQR 库客户端解码，支持摄像头getUserMedia实时扫描
- 二维码历史：localStorage存储最近50条扫描记录
