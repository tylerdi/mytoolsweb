...
(function () {
  ...
  class FishJoke {
    ...
    render() {
      this.el.innerHTML = `
      <style>
        .jk-wrap{background:var(--surface,#111);border:1px solid var(--border,#1e1e1e);border-radius:16px;padding:24px;text-align:center;font-family:'LXGW WenKai',-apple-system,sans-serif;;width:100%;margin:0 auto}
